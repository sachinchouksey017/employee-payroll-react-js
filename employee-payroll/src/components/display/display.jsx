            ...
            <tbody>
                ...
                </tr>
                {
                    props.employeeArray && props.employeeArray.map((element, ind) => (
                        <tr key={ind}>
                            <td><img className="profile" src={element.profileUrl === '../../assets/profile-images/Ellipse -3.png' ?
                                profile1 : element.profileUrl === '../../assets/profile-images/Ellipse 1.png' ?
                                    profile2 : element.profileUrl === '../../assets/profile-images/Ellipse -8.png' ?
                                        profile3 : profile4} alt="" /></td>
                            <td>{element.name}</td>
